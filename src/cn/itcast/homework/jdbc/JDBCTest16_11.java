 ...
 */
public class JDBCTest16_11 {
    //编写方法查询指定部门的所有员工信息，返回List<Employee>集合
    public static void main(String[] args) throws UnsupportedEncodingException {
        System.out.println(new JDBCTest16_11().getAllEmpByDName("财务部"));
    }

    public List<Emp> getAllEmpByDName(String dname) {
        ...
        try {
            ...
            String sql = "select * from emp where dept_id = (select did from dept where dname = ?)";
