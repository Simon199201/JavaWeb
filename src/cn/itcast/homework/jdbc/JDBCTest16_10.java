 ...
 */
public class JDBCTest16_10 {
    //编写方法接收一个工资参数，方法内查询工资大于等于传入的工资的员工，返回符合条件所有员工信息List<Employee>集合。
    public static void main(String[] args) throws UnsupportedEncodingException {
        System.out.println(new JDBCTest16_10().findEmpByName(3000));
    }

    public List<Emp> findEmpByName(double salary) {
        ...
        try {
            ...
            while (resultSet.next()) {
                ...
                double sa = resultSet.getDouble(5);
